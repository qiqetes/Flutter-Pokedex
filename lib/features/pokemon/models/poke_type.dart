...
enum PokeType {
  water(1, color: Color(0xff539ae2), secondaryColor: Color(0xff76baf0)),
  steel(8, color: Color(0xff89a1b0), secondaryColor: Color(0xffaabfc8)),
  rock(6, color: Color(0xffb2a061), secondaryColor: Color(0xffc9bb7c)),
  psychic(5, color: Color(0xffe5709b), secondaryColor: Color(0xfff691b4)),
  ...
  ice(3, color: Color(0xff70cbd4), secondaryColor: Color(0xff94e3e8)),
  ...
  dragon(9, color: Color(0xff6a7baf), secondaryColor: Color(0xff7f99cc)),
